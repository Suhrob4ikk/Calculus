...
<body style="margin:0;padding:0;background:#f0f4ff;font-family:'Segoe UI',Arial,sans-serif">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f4ff;padding:32px 16px">
        ...
        <tr>
          <td style="padding:32px 32px 24px">
            ...
            <ul style="margin:0 0 20px;padding-left:20px;color:#475569;
              ...
              <li>📂 <strong>5 разделов</strong> — Интегралы, Производные, Пределы, Ряды и Диф. уравнения</li>
              <li>📚 <strong>Подробные теории</strong> с объяснениями как «студент студенту» и реальными примерами</li>
              <li>⚔️ <strong>Режим Дуэли</strong> — сразись с другим студентом в реальном времени</li>
              <li>🔥 <strong>Ежедневный вызов</strong> — одна задача в день, зарабатывай XP и страйки</li>
              <li>🏆 <strong>Таблица лидеров</strong> — соревнуйся и следи за своим местом</li>
              <li>📊 <strong>Статистика</strong> — смотри свой прогресс по каждому разделу</li>
            </ul>
    ...
    text:
      `Добрый день, ${name}!\n\n` +
      `Давно тебя не было на тренажёре по матанализу. Пока ты отсутствовал, у нас появилось много нового:\n\n` +
      `📂 5 разделов — Интегралы, Производные, Пределы, Ряды и Диф. уравнения\n` +
      `📚 Подробные теории с объяснениями как «студент студенту» и реальными примерами\n` +
      `⚔️ Режим Дуэли — сразись с другим студентом в реальном времени\n` +
      `🔥 Ежедневный вызов — одна задача в день, зарабатывай XP и страйки\n` +
      `🏆 Таблица лидеров — соревнуйся и следи за своим местом\n` +
      `📊 Статистика — смотри свой прогресс по каждому разделу\n\n` +

...
const mediumIntegralsQuestions = [
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\sin(x)}{1 + \\cos^2(x)}  dx\\\\)",
    options: [
      "\\\\(\\arctan(\\cos(x)) + C\\\\)",
      "\\\\(\\ln|1 + \\cos^2(x)| + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\cos(x)}{\\sqrt{4 - \\sin^2(x)}}  dx\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{1}{x\\sqrt{1 - \\ln^2(x)}}  dx\\\\)",
    options: [
      "\\\\(\\arccos(\\ln(x)) + C\\\\)",
      "\\\\(\\ln|\\sqrt{1 - \\ln^2(x)}| + C\\\\)",
      "\\\\(\\arcsin(\\ln(x)) + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{e^{2x}}{\\sqrt{1 - e^{4x}}}  dx\\\\)",
    options: [
      "\\\\(\\arcsin(e^{2x}) + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\sin(2x)}{\\sqrt{1 - \\cos^2(x)}}  dx\\\\)",
    options: [
      "\\\\(2\\cos(x) + C\\\\)",
      "\\\\(\\frac{1}{2}\\sin^2(x) + C\\\\)",
      "\\\\(\\ln|\\sin(x)| + C\\\\)",
  ...
  },
  {
    ...
    options: [
      ...
      "\\\\(\\arctan(\\frac{x-3}{2}) + C\\\\)",
      "\\\\(\\frac{1}{x^2 - 6x + 13} + C\\\\)",
      "\\\\(\\ln|x^2 - 6x + 13| + 5\\arctan(\\frac{x-3}{2}) + C\\\\)",
    ],
    correct: 3,
  },
  {
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{1}{x\\ln(x)\\sqrt{\\ln^2(x) - 1}}  dx\\\\)",
    options: [
      "\\\\(\\arcsec(|\\ln(x)|) + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\sin(2x)}{1 + \\cos^4(x)}  dx\\\\)",
    options: [
      "\\\\(\\arctan(\\cos^2(x)) + C\\\\)",
      "\\\\(\\ln|1 + \\cos^4(x)| + C\\\\)",
      "\\\\(\\frac{1}{2}\\sin^2(x) + C\\\\)",
  ...
  },
  {
    ...
    options: [
      "\\\\(\\frac{1}{32}(2x+1)^9 - \\frac{1}{32}(2x+1)^8 + C\\\\)",
      "\\\\(\\frac{x}{8}(2x+1)^8 + C\\\\)",
      "\\\\(\\frac{1}{16}(2x+1)^8 + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\sqrt{1 + \\sqrt{x}}}{\\sqrt{x}}  dx\\\\)",
    options: [
      "\\\\(2\\sqrt{1 + \\sqrt{x}} + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{x + 2}{\\sqrt{x^2 + 4x + 5}}  dx\\\\)",
    options: [
      "\\\\(\\sqrt{x^2 + 4x + 5} + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\cos(x)}{\\sin^3(x) + \\sin(x)}  dx\\\\)",
    options: [
      "\\\\(\\frac{1}{\\sin(x)} + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{1}{(x+1)\\sqrt{x^2 + 2x}}  dx\\\\)",
    options: [
      "\\\\(\\arcsec(|x+1|) + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\sin(x) + \\cos(x)}{\\sin(x) - \\cos(x)}  dx\\\\)",
    options: [
      "\\\\(\\ln|\\sin(x) + \\cos(x)| + C\\\\)",
      "\\\\(\\ln|\\sin(x) - \\cos(x)| + C\\\\)",
      "\\\\(-\\ln|\\sin(x) + \\cos(x)| + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{1}{\\sqrt{x}(1 + x^{3/2})}  dx\\\\)",
    options: [
      "\\\\(\\ln|1 + x^{3/2}| + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\cos(2x)}{\\sin^2(x)\\cos^2(x)}  dx\\\\)",
    options: [
      "\\\\(\\tan(x) - \\cot(x) + C\\\\)",
      "\\\\(\\ln|\\sin(x)\\cos(x)| + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{\\sin(2x)}{\\sqrt{1 - \\sin^4(x)}}  dx\\\\)",
    options: [
      "\\\\(\\arccos(\\sin^2(x)) + C\\\\)",
      "\\\\(\\arcsin(\\sin^2(x)) + C\\\\)",
      "\\\\(\\ln|1 - \\sin^4(x)| + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{e^{\\sqrt{x}}}{\\sqrt{x}}  dx\\\\)",
    options: [
      "\\\\(e^{\\sqrt{x}} + C\\\\)",
      "\\\\(\\frac{1}{2}e^{\\sqrt{x}} + C\\\\)",
      "\\\\(\\sqrt{x}e^{\\sqrt{x}} + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{e^x - e^{-x}}{e^x + e^{-x}}  dx\\\\)",
    options: [
      "\\\\(\\ln|e^x + e^{-x}| + C\\\\)",
      "\\\\(\\arctan(e^x) + C\\\\)",
      "\\\\(\\frac{1}{e^x + e^{-x}} + C\\\\)",
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{1}{\\sqrt{x}(1 + \\sqrt{x})}  dx\\\\)",
    options: [
      "\\\\(2\\ln|1 + \\sqrt{x}| + C\\\\)",
      "\\\\(\\ln|1 + \\sqrt{x}| + C\\\\)",
      "\\\\(\\frac{1}{1 + \\sqrt{x}} + C\\\\)",
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{x}{x^2 + 4x + 5}  dx\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{2x + 3}{x^2 + 2x + 2}  dx\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{dx}{x^2 \\sqrt{4 - x^2}}\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{x^2 + 1}{x^3 - x}  dx\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{\\cos(x)}{\\sin^2(x) + 4\\sin(x) + 4}  dx\\\\)",
    options: [
      "\\\\(\\frac{1}{\\sin(x) + 2} + C\\\\)",
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\sqrt{x} \\\\cdot \\ln(x)  dx\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{x^3}{\\sqrt{9 - x^2}}  dx\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{\\sin(2x)}{1 + \\cos^2(x)}  dx\\\\)",
    options: [
      "\\\\(-\\ln|1 + \\cos^2(x)| + C\\\\)",
      "\\\\(\\ln|1 + \\cos^2(x)| + C\\\\)",
      "\\\\(-2\\ln|1 + \\cos^2(x)| + C\\\\)",
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{dx}{x\\sqrt{x^2 - 9}}\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{x^2 + 2x + 3}{(x+1)^3}  dx\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{dx}{\\sqrt{4x^2 + 12x + 10}}\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{e^{2x}}{e^x + 1}  dx\\\\)",
    options: [
      "\\\\(e^x - \\ln|e^x + 1| + C\\\\)",
      "\\\\(e^x + \\ln|e^x + 1| + C\\\\)",
  ...
  {
    question:
      "Вычислите интеграл \\\\(\\int \\frac{\\arctan(x)}{1 + x^2}  dx\\\\)",
    options: [
      "\\\\(\\ln|1 + x^2| \\arctan(x) + C\\\\)",
      "\\\\(\\arctan(x))^2 + C\\\\)",
...
const hardIntegralsQuestions = [
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{dx}{\\sqrt{x} + \\sqrt[4]{x}}\\\\)",
    options: [
  ...
  {
    question:
      "Вычислите \\\\(\\int \\frac{dx}{\\sqrt{x} + \\sqrt[3]{x}}\\\\)",
    options: [

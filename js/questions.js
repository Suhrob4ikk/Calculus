  // Вопросы для раздела "Ряды и последовательности"
      ...
      const hardSeriesQuestions = [
        {
          question:
            "Сходится ли ряд $\\sum_{n=1}^{\\infty} \\frac{\\sin(n)}{n^2}$?",
          options: [
        ...
        {
          question:
            "Какой из следующих рядов сходится равномерно на всей числовой прямой?",
          options: [
        ...
        {
          question:
            "Какой признак сходимости используется для рядов с положительными членами?",
          options: [
            "Признак сравнения",
            "Признак Лейбница",
            "Признак Абеля",
